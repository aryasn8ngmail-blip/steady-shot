...
def run():
	...
	# Verify GDScript syntax / structural integrity of core GDScript files
	files_to_check = [
	...
	for file_path in files_to_check:
		...
		# Basic syntax validation for GDScript keywords
	...
	# Check if godot executable is available in PATH to run full headless suite
	godot_cmd = "godot"
	try:
